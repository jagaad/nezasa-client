...
./scripts/generate-types.sh openapi/webhook-api-models-v1.yaml types/webhook-api-models-v1.ts

./scripts/generate-types.sh openapi/planner-api-v1.yaml types/planner-api-v1.ts # FIX
./scripts/generate-types.sh openapi/webhook-api-v1.yaml types/webhook-api-v1.ts # FIX